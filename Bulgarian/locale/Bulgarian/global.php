<?php
$locale['setlocale'] = "bg_BG"; // https://www.php.net/manual/en/function.setlocale.php
...
$locale['tinymce'] = "bg_BG"; // refer to path locale/Lang/includes/jscripts/tinymce/langs/{value}.js
