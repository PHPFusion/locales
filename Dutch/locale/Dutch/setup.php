...
$locale['setup_0022'] = "Welkom bij PHP-Fusion Upgrading Service";
$locale['setup_0023'] = "De upgrade service zal u begeleiden door de stappen die nodig zijn om PHP-Fusion CMS op uw server te upgraden. Volg deze stappen en controleer alle vereiste informatie.";
...
$locale['setup_0109'] = "De minimale versie van Apache die nodig is om PHP-Fusion te voeren zonder mod_rewrite in te schakelen is 2.2.16.";
...
$locale['setup_0113'] = "Uw PHP installatie is te oud. PHP-Fusion vereist een minimum versie van 5.6.39. PHP versies hoger dan 5.6.39 bieden ingebouwde SQL injectie bescherming voor mysql databases. Het wordt aanbevolen om bij te werken.";
$locale['setup_0114'] = "PHP-Fusion vereist dat u de PHP extensies inschakelt volgens onderstaande lijst";
...
$locale['setup_0132'] = "Stel {%code%} in in uw PHP configuratie omdat sommige pagina's op uw PHP-Fusion site niet werken wanneer deze instelling te laag is.";
...
$locale['setup_1210'] = "PHP-Fusion installatiefouten. Herstart de installatie.";
$locale['setup_1211'] = "Nieuwe PHP-Fusion-installatie voltooid. Ga naar de volgende stap.";
...
$locale['setup_1216'] = "PHP-Fusion is een lichtgewicht open source content management systeem (CMS) geschreven in PHP.";
$locale['setup_1217'] = "Uw account is bijgewerkt. Gebruik de nieuwe inloggegevens vanaf nu.";
$locale['setup_1220'] = "De naam van de database die u PHP-Fusion wilt laten uitvoeren";
...
$locale['setup_1701'] = "PHP-Fusion 9 is nu klaar voor gebruik. Klik op Voltooien om uw config_temp.php bestand te herschrijven naar config.php<br/>";
