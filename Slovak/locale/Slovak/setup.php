<?php
$locale['setup_0000'] = "PHPFusion - Inštalácia";
$locale['setup_0002'] = "Vitajte v inštalácii PHPFusion";
$locale['setup_0003'] = "Inštalačný sprievodca vás prevedie krokmi potrebnými na inštaláciu PHPFusion CMS na Váš server. Ak potrebujete ďalšiu pomoc, prosím skontrolujte našu <a class='strong' href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=216' target='_blank'>online dokumentáciu inštalácie</a>.";
$locale['setup_0005'] = " Prečítal som a súhlasim s PHPFusion <a href='https://phpfusion.com/licensing/?agpl' target='_blank'>podmienkami používania</a>";
$locale['setup_0006'] = "PHPFusion 9 vyžaduje minimálne PHP 7.0. Pre viac informácií si pozrite <a href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=215'>systémové požiadavky</a>.";
...
$locale['setup_5000'] = "Aby ste mohli používať PHPFusion, musíte skontrolovať a súhlasiť s podmienkami PHPFusion.";
$locale['setup_0010'] = "Aktuálna verzia zostavy: ";
$locale['setup_0011'] = "sk";
$locale['setup_0012'] = "utf-8";
$locale['setup_0012a'] = "ltr";
$locale['setup_0020'] = "Aktualizácia PHPFusion";
$locale['setup_0022'] = "Vitajte v aktualizačnej službe PHPFusion";
$locale['setup_0023'] = "Služba inovácií vás prevedie krokmi potrebnými na inováciu PHPFusion CMS na váš server. Postupujte podľa týchto krokov a overte si všetky požadované informácie.";
...
$locale['setup_0102'] = "Systémové požiadavky";
...
$locale['setup_0109'] = "Minimálna verzia Apache potrebná na spustenie PHPFusion bez povoleného mod_rewrite je 2.4.";
$locale['setup_0110'] = "Kvôli nastaveniam Server tokenov v httpd.conf nie je možné určiť verziu Apache bez mod_rewrite, je potrebná minimálna verzia 2.4.";
...
$locale['setup_0113'] = "Vaša PHP inštalácia je príliš stará. PHPFusion vyžaduje minimálne 7.0. PHP verzie vyššie ako 7.0 poskytujú zabudovanú ochranu proti SQL injection pre mysql databázy. Odporúča sa aktualizovať.";
$locale['setup_0114'] = "PHPFusion vyžaduje, aby ste povolili rozšírenie PHP v nasledujúcom zozname";
...
$locale['setup_0119b'] = "Zvýšte limit pamäte úpravou parametra memory_limit v súbore [CFG_FILE_PATH] a potom reštartujte webový server (alebo kontaktujte svojho správcu systému alebo poskytovateľa hostingu).";
...
$locale['setup_0132'] = "Nastavte {%code%} v konfigurácii PHP ako niektoré stránky v PHPFusion nebudú fungovať, ak je toto nastavenie príliš nízke.";
...
$locale['setup_1001'] = "Stiahnuť viac lokalizácií z <a href='https://phpfusion.com/translations/' target='_blank'><strong>Oficiálnej PHPFusion podpori</strong></a>";
$locale['setup_1002'] = "Vitajte v režime obnovy PHPFusion 9.";
...
$locale['setup_1210'] = "Chyby PHPFusion inštalácie. Reštartujte inštalátor.";
$locale['setup_1211'] = "Bola dokončená nová PHPFusion inštalácia. Prejdite k ďalšiemu kroku.";
...
$locale['setup_1215'] = "Stránku poháňa PHPFusion";
$locale['setup_1216'] = "PHPFusion je ľahký open source redakčný systém (CMS) napísaný v PHP.";
$locale['setup_1217'] = "Váš účet je aktualizovaný. Odteraz použite nové poverenie.";
$locale['setup_1220'] = "Názov databázy, na ktorej chcete spustiť PHPFusion";
...
$locale['setup_3021'] = "Informácie o serveri";
...
$locale['setup_3321'] = "Moje sledované vlákna";
$locale['setup_3322'] = "Nezodpovedané témy";
...
$locale['setup_1701'] = "PHPFusion 9 je teraz pripravený na použitie. Kliknutím na tlačidlo Dokončiť prepíše sa súbor config_temp.php na config.php<br/>";
...
$locale['setup_1703'] = "Ďakujeme, že ste si vybrali PHPFusion.";
