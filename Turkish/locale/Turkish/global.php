<?php
$locale['setlocale'] = "tr_TR"; // https://www.php.net/manual/en/function.setlocale.php
$locale['charset'] = "utf-8"; // https://www.iana.org/assignments/character-sets/character-sets.xhtml
$locale['region'] = "TR"; // ISO-3166 (Alpha-2 code) https://www.iso.org/obp/ui/#search
$locale['xml_lang'] = "tr"; // ISO 639-1 Code http://www.loc.gov/standards/iso639-2/php/code_list.php
$locale['short_lang_name'] = "tr"; // ISO 639-1 Code http://www.loc.gov/standards/iso639-2/php/code_list.php
$locale['tinymce'] = "tr"; // refer to path locale/Lang/includes/jscripts/tinymce/langs/{value}.js
$locale['select2'] = "tr"; // refer to path locale/Lang/includes/dynamics/assets/select2/select2_locale_{value}.js
$locale['phpmailer'] = "tr"; // refer to path locale/Lang/includes/classes/PHPMailer/language/phpmailer.lang-{value}.php
$locale['filemanager'] = "tr"; // refer to path locale/Lang/includes/elFinder/js/i18n/{value}.js
$locale['datepicker'] = "tr"; // refer to path locale/Lang/includes/dynamics/assets/datepicker/locale/{value}.js
$locale['password_strength'] = "tr"; // refer to path locale/Lang/includes/dynamics/assets/password/lang/{value}.js
...
$locale['username_pretext'] = "Herkese açık kullanıcı adınız aynı zamanda bulunan kullanıcı profil adresinizle aynı: %s %s";
$locale['first_name'] = "Adınız";
$locale['middle_name'] = "Göbek Adınız";
$locale['last_name'] = "Soyadınız";
// Documents
$locale['doc_type'] = "Belge Türü";
$locale['doc_series'] = "Sıra";
...
$locale['global_045'] = "Görüntülenme";
...
$locale['global_089b'] = "Küçük resim görüntüsü";
...
// Miscellaneous
$locale['global_900'] = "HEX DEC dönüştürme işlemi yapılamadı";
...
$locale['can'] = "yapabilmek";
$locale['cannot'] = "yapamamak";
$locale['no'] = "Hayır";
$locale['yes'] = "Evet";
$locale['off'] = "Kapalı";
$locale['on'] = "Açık";
...
$locale['root'] = "Ebeveyn olarak";
$locale['choose-user'] = "Lütfen Bir Kullanıcı Seçiniz...";
$locale['choose-location'] = "Lütfen Bir Yer Seçiniz";
$locale['parent'] = "Yeni Ebeveyn Olarak Oluştur..";
$locale['item_order'] = "Öğe Düzeni";
$locale['status'] = "Durum";
$locale['note'] = "Bu öğeyi not edin";
$locale['publish'] = "Yayınla";
$locale['unpublish'] = "Yayınlama";
$locale['published'] = "Yayınlanmış";
$locale['unpublished'] = "Yayınlanmamış";
$locale['sticky'] = "İşaretli";
$locale['unsticky'] = "İşareti Kaldır";
$locale['draft'] = "Taslak";
...
$locale['submit_access'] = "Gönder sayfasına erişim";
$locale['categories'] = "Kategoriler";
$locale['thumbnail'] = "Küçük resimler";
// Alignment
$locale['left'] = "Sol";
...
$locale['fmt_read'] = "okur|okuma";
$locale['fmt_second'] = "saniye|saniyeler";
$locale['fmt_shouts'] = "sesleniş|seslenişler";
$locale['fmt_thread'] = "başlık|başlıklar";
$locale['fmt_user'] = "üye|üyeler";
$locale['fmt_views'] = "görüntüleme|görüntülenmeler";
$locale['fmt_weblink'] = "web bağlantısı|web bağlantıları";
