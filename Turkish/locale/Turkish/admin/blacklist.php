...
$locale['BLS_013'] = "Kullanıcı Kara Listeden Silindi";
$locale['BLS_014'] = "Bu Girişi Silmek İstediğinizden Emin Misiniz?";
$locale['BLS_015'] = "Kara Liste Şu An Boş.";
$locale['BLS_016'] = "Kara Liste E-Posta Adresi Geçerli Bir E-Posta Değil.";

$locale['BLS_020'] = "Kara Liste Kullanıcısı";
$locale['BLS_021'] = "Kara Listeye Alınmış Kullanıcıyı Düzenle";
$locale['BLS_022'] = "Kara Listeye Kullanıcı Ekle";
$locale['BLS_023'] = "Şu Anda %d - %d Toplam Kara Liste Girişleri Görüntüleniyor.";

$locale['BLS_030'] = "Kara Liste Bilgisi";
$locale['BLS_031'] = "Yönetici";
$locale['BLS_032'] = "Tarih";
$locale['BLS_033'] = "Seçenekler";
$locale['BLS_034'] = "Kara Liste IP Adresi: [STRONG]or[/STRONG]";
...
domain.tld v7'de Tanımlanan Kurallarla Uyumlu Hale Getirmek Için %@domain.tld'nin Bir Takma Adıdır.<br />";
