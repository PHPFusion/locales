...
$locale['BLS_MS'] = "Įrašius IP adresą, to adreso sąvininkui bus apribotas lankymasis svetainėje. Galite įrašyti pilną IP, pvz.: <em>123.123.123.123</em>, arba IP dalį, pvz.:
...
<br /><br />
Įrašius el. pašto adresą bus apribota registracija, su tuo el. pašto adresu. 
Galite įrašyti pilną adresą, pvz.: <em>123@on.lt</em>, arba el. pašto domainą, pvz.: <em>on.lt</em>

<br /><br />

% - bet koks simbolis.<br /><br />

%.%.%.%@domain.tld blokuoja bet kokį adresą, kuriame yra bent 3 taškai.<br />
%+%@domain.tld blokuoja bet kokį adresą, kuriame yra bent vienas pliuso ženklas.<br />
