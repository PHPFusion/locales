...
$locale['setup_0020'] = "Mise à jour de PHP-Fusion";
$locale['setup_0022'] = "Bienvenue dans le service de mise à jour de PHP-Fusion";
$locale['setup_0023'] = "Le service de mise à niveau vous guidera à travers les étapes requises pour mettre à niveau le CMS PHP-Fusion sur votre serveur. Veuillez suivre ces étapes et vérifier chaque information requise.";
...
$locale['setup_0109'] = "La version minimale d'Apache nécessaire pour exécuter PHP-Fusion sans mod_rewrite est 2.4.";
...
$locale['setup_0113'] = "Votre installation de PHP est trop ancienne. PHP-Fusion requiert au moins un minimum de 7.0. fournit une protection intégrée par injection SQL pour les bases de données mysql. Il est recommandé de mettre à jour.";
$locale['setup_0114'] = "PHP-Fusion nécessite d'activer l'extension PHP dans la liste suivante";
...
$locale['setup_1215'] = "Site Web propulsé par PHP-Fusion";
$locale['setup_1216'] = "PHP-Fusion est un système de gestion de contenu open source léger (CMS) écrit en PHP.";
$locale['setup_1217'] = "Votre compte est mis à jour. Veuillez utiliser les nouveaux identifiants à partir de maintenant.";
$locale['setup_1220'] = "Le nom de la base de données que vous voulez exécuter PHP-Fusion";
...
$locale['setup_1703'] = "Merci d'avoir choisi PHP-Fusion.";
