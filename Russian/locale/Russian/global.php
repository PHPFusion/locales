...
$locale['datepicker'] = "ru-ru"; // refer to path locale/Lang/includes/dynamics/assets/datepicker/locale/{value}.js
...
$locale['global_301'] = "К сожалению, эта страница не может быть отображена. По каким-тоо причинам файлы темы оформления не были найдены.
 Если Вы администратор сайта, при помощи FTP-клиента загрузите тему оформелния, созданную для PHPFusion 9, в папку тем.
...
$locale['timer_second'] = "секунда|секунды|секунд";
