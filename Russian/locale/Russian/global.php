...
$locale['global_199'] = "Внимание: не установлен административный пароль, нажмите &laquo;[LINK]Изменить профиль[/LINK]&raquo; для установки.";
//Titles
$locale['global_200'] = " - ";
$locale['global_201'] = ": ";
...
$locale['global_301'] = "К сожалению, эта страница не может быть отображена. По каким-тоо причинам файлы темы оформления не были найдены. Если Вы администратор сайта, при помощи FTP-клиента загрузите тему оформелния, созданную для PHP-Fusion 9, в папку тем. После загрузки проверьте в настройках тем, что тема оформления корректно загружена на сайт. Пожалуйста, убедитесь, что папка с темой имеет такое же название (включая регистр символов, что важно на серверах под управлением Unix-систем), как и выбранная в Основных параметрах.\n\nЕсли Вы обычный пользователь сайте, пожалуйста, свяжитесь с администратором через электропочту [SITE_EMAIL] и сообщите о случившемся.";
$locale['global_302'] = "Тема, выбранная в настройках, не существует или повреждена!";
// JavaScript Not Enabled
$locale['global_303'] = "О, нет! Где JavaScript?\nВаш браузер не поддерживает JavaScript или же JavaScript отключен в настройках. Пожалуйста, включите JavaScript в браузере для корректного отображения сайта или обновите свой браузер на поддерживающий JavaScript.";
// User Management
...
Свяжитесь с администратором по электропочте [SITE_EMAIL] для восстановления Вашей учётной записи или для информирования о том, что Вы не размещали сообщений.\n
С уважением,\n[SITEUSERNAME]";
// Authenticate Class
...
\n\nДля Вашей уччётной записи на сайте [SITENAME] был созда новый пароль. Пожалуйста, ознакомьтесь с прилагаемыми данными для входа:\n\n
Имя пользователя: USER_NAME\nПароль: [PASSWORD]С уважением,\n[SITEUSERNAME]";
