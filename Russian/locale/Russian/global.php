 ...
 * Russian Locale
 *
 * @locale tinymce           refer to path includes/jscripts/tiny_mce/langs/{value}.js
...
$locale['UM095'] = "Добавить запись в блог";
...
// Keywords and Meta
$locale['tags'] = "Теги";
$locale['notfound'] = "Ничего не найдено";
$locale['sel_user'] = "Выберите участника";
// Captcha
...
$locale['global_192'] = "Ваша сессия завершена. Пожалуйста, авторизуйтесь снова.";
...
$locale['global_301'] = "К сожалению, эта страница не может быть отображена. По каким-тоо причинам файлы темы оформления не были найдены.
 Если Вы администратор сайта, при помощи FTP-клиента загрузите тему оформелния, созданную для PHP-Fusion 8, в папку тем.
 ...
 как и выбранная в Основных параметрах.<br/>Если Вы обычный пользователь сайте, пожалуйста, свяжитесь с администратором по Е-майлу  [SITE_Е-майл] и сообщите о случившемся.";
...
$locale['global_442'] = "Здравствуйте [USER_NAME],<br/>
...
Пожалуйста, свяжитесь с администратором сайта [SITE_Е-майл]  для восстановления Вашей учётной записи или для информирования о том, что Вы не размещали сообщений.\n
...
$locale['global_452'] = "Здравствуйте USER_NAME,<br/>
...
С уважением,<br/>[SITEUSERNAME]";
$locale['global_453'] = "Здравствуйте, USER_NAME,<br/>Приостановка действия вашей учётной записи на сайте [SITEURL] была снята.<br/>
С уважением,<br/>[SITEUSERNAME]";
$locale['global_454'] = "Учётная запись повторно активирована на сайте «[SITENAME]»";
$locale['global_455'] = "Здравствуйте USER_NAME,<br/>
...
//Safe Redirect
$locale['global_500'] = "Вы будете перенаправлены %s, пожалуйста, подождите. Если Вас не перенаправило, нажмите здесь.";
// Captcha Locales
