...
$locale['filemanager'] = "ru"; // refer to path includes/filemanager/lang/{value}.php
$locale['datepicker'] = "ru"; // // refer to path includes/dynamics/assets/datepicker/locale/{value}.js
...
$locale['sel_country'] = "Выберите страну";
$locale['sel_state'] = "Выберите регион";
$locale['sel_user'] = "Выберите имя пользователя";
$locale['add_language'] = "Добавить переводы";
$locale['add_lang'] = "Добавить язык: %s";
$locale['other_states'] = "Другие регионы";
// Name
$locale['name'] = "Полное имя";
$locale['username_pretext'] = "Ваше публичное имя пользователя, то же, что указанное в профиле адреса: %s %s";
...
$locale['status1'] = "Забанен";
$locale['status2'] = "Неактивирован";
$locale['status3'] = "Приостановлен";
$locale['status4'] = "Забанен по безопасности";
$locale['status5'] = "Отменён";
...
$locale['global_016'] = "Новый участник";
...
$locale['global_101a'] = "Логин";
$locale['global_101b'] = "Е-майл";
...
$locale['UM061b'] = "Логин или Е-майл";
$locale['UM062'] = "Пароль";
$locale['UM063'] = "Запомнить";
$locale['UM064'] = "Логин";
$locale['UM065'] = "Не зарегистрированы? [LINK]Нажмите[/LINK] для регистрации.";
$locale['UM066'] = "Забыли пароль?<br/>[LINK]Запросите новый здесь[/LINK].";
...
$locale['global_171'] = "посетителей на ";
...
$locale['global_176'] = "Политика приватности";
// Admin Navigation
...
$locale['global_301'] = "К сожалению, эта страница не может быть отображена. По каким-тоо причинам файлы темы оформления не были найдены.
 Если Вы администратор сайта, при помощи FTP-клиента загрузите тему оформелния, созданную для PHP-Fusion 9, в папку тем.
 После загрузки проверьте в настройках тем, что тема оформления корректно загружена на сайт.
 Пожалуйста, убедитесь, что папка с темой имеет такое же название (включая регистр символов, что важно на серверах под управлением Unix-систем),
 как и выбранная в Основных параметрах.<br/>Если Вы обычный пользователь сайте, пожалуйста, свяжитесь с администратором по Е-майлу  [SITE_EMAIL] и сообщите о случившемся.";
$locale['global_302'] = "Тема, выбранная в настройках, не существует или повреждена!";
// JavaScript Not Enabled
$locale['global_303'] = "О, нет! Где JavaScript?<br/>Ваш браузер не поддерживает JavaScript или же JavaScript отключен в настройках. Пожалуйста, включите JavaScript в браузере для корректного отображения сайта или обновите свой браузер на поддерживающий JavaScript.
Включите JavaScript в своем веб-браузере, чтобы правильно просматривать этот веб-сайт или обновить веб-браузер, поддерживающий JavaScript.";
// User Management
...
$locale['global_442'] = "Приветствую, [USER_NAME],<br/>
...
Свяжитесь с администратором по Е-майлу: [SITE_EMAIL] для восстановления Вашей учётной записи или для информирования о том, что Вы не размещали сообщений.

С уважением,<br/>[SITEUSERNAME]";
// Authenticate Class
$locale['global_450'] = "Приостановка автоматически снята системой";
$locale['global_451'] = "Приостановка снята системой на сайте «[SITENAME]»";
$locale['global_452'] = "Приветствую, USER_NAME,<br/>
Приостановка действия Вашей учётной записи на сайте [SITEURL] была снята. Информация для входа:<br/>
Имя пользователя: USER_NAME<br/>Пароль: Скрыт по соображениям безопасности<br/>
Если Вы забыли свой пароль, его можно восстановить по этой ссылке: LOST_PASSWORD<br/>
С наилучшими пожеланиями,<br/>[SITEUSERNAME]";
$locale['global_453'] = "Приветствую, USER_NAME,<br/>Приостановка действия вашей учётной записи на сайте [SITEURL] была снята.<br/>
С наилучшими пожеланиями,<br/>[SITEUSERNAME]";
$locale['global_454'] = "Учётная запись повторно активирована на сайте «[SITENAME]»";
$locale['global_455'] = "Приветствую, USER_NAME,<br/>
При последнем Вашем входе на сайт [SITEURL] ваша учётная запись была повторно активирована и больше не помечена как неактивная.<br/>
С наилучшими пожеланиями,<br/>[SITEUSERNAME]";
$locale['global_456'] = "Уведомление о новом пароле для сайта «[SITENAME]»";
$locale['global_457'] = "Приветствую, USER_NAME!
<br/>Для Вашей учётной записи на сайте «[SITENAME]» был создан новый пароль. Пожалуйста, ознакомьтесь с прилагаемыми данными для входа:<br/>
Имя пользователя: USER_NAME<br/>Пароль: [PASSWORD]<br/>С уважением,<br/>[SITEUSERNAME]";
$locale['global_458'] = "Для пользователя USER_NAME был установлен новый пароль";
$locale['global_459'] = "Для пользователя USER_NAME был установлен новый пароль, но уведомление не было отправлено. Пожалуйста, убедитесь, что пользователь проинформирован о новом пароле.";
...
$locale['global_601'] = "Следует ввести правильный код проверки";
$locale['recaptcha'] = "ru";
// Site links
...
$locale['fmt_download'] = "раз|раза|раз";
...
$locale['fmt_admin'] = "администраторы|администратора|администраторов";
$locale['fmt_group'] = "группа|группы|групп";
$locale['fmt_category'] = "категория|категории|категорий";
