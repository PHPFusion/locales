...
$locale['setup_0003'] = "Установщик проведёт Вас через все шаги, необходимые для установки PHP-Fusion на Ваш сервер. Если Вам нужна дополнительная помощь, пожалуйста, проверьте нашу <a class='strong' href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=216'>онлайн-документацию по установке</a>.";
$locale['setup_0005'] = " Я прочитал и соглашаюсь с <a href='https://www.phpfusion.com/license/?agpl' target='_blank'>Правилами и условиями использования</a> PHP-Fusion.";
$locale['setup_0006'] = "PHP-Fusion 9 требует как минимум PHP 7.0. Посмотрите <a href='https://www.phpfusion.com/infusions/wiki/documentation.php?page_id=215'>системные требования</a> для подробной информации.";
...
$locale['setup_0109'] = "Минимальная версия сервера Apache, требуемая для запуска PHP-Fusion без включенного mod_rewrite 2.4.";
...
$locale['setup_0113'] = "Ваша установленная копия PHP слишком старая. PHP-Fusion требует как минимум версии 7.0. Версии PHP выше 7.0 обеспечивают встроенную защиту от SQL-инъекций для баз данных MySQL. Рекомендуем Вам обновить свою версию.";
...
$locale['setup_1001'] = "Больше переводов можно загрузить с <a href='https://translations.phpfusion.com/' target='_blank'><strong>Официального сайта поддержки PHP-Fusion</strong></a>";
$locale['setup_1002'] = "Добро пожаловать в режим восстановления PHP-Fusion 9.";
...
$locale['setup_1216'] = "PHP-Fusion лёгкая система управления содержимым (CMS) с открытым исходным кодом, написанная на PHP.";
