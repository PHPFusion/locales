...
$locale['setup_0052'] = "Расширения PHP";
...
$locale['setup_0109'] = "Минимальная версия сервера Apache, требуемая для запуска PHP-Fusion без включенного mod_rewrite 2.2.16.";
...
$locale['setup_0113'] = "Ваша установленная копия PHP слишком старая. PHP-Fusion требует как минимум версии 5.6.39. Версии PHP выше 5.6.39 обеспечивают встроенную защиту от SQL-инъекций для баз данных MySQL. Рекомендуем Вам обновить свою версию.";
...
$locale['setup_1001'] = "Больше переводов можно загрузить с <a href='https://www.php-fusion.co.uk/php_fusion_9_downloads.php'><strong>официального сайта поддержки PHP-Fusion</strong></a>";
