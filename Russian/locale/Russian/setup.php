<?php
$locale['setup_0000'] = "Установка PHPFusion Core 9 Edition";
$locale['setup_0002'] = "Добро пожаловать в установку PHPFusion";
$locale['setup_0003'] = "Установщик проведёт Вас через все шаги, необходимые для установки PHPFusion на Ваш сервер. Если Вам нужна дополнительная помощь, пожалуйста, проверьте нашу <a class='strong' href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=216'>онлайн-документацию по установке</a>.";
$locale['setup_0005'] = " Я прочитал и соглашаюсь с <a href='https://phpfusion.com/license/?agpl' target='_blank'>Правилами и условиями использования</a> PHPFusion.";
$locale['setup_0006'] = "PHPFusion 9 требует как минимум PHP 7.0. Посмотрите <a href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=215'>системные требования</a> для подробной информации.";
...
$locale['setup_5000'] = "Для установки и использования PHPFusion Вы дожлжны ознакомиться с правилами и принять их.";
$locale['setup_0010'] = "Текущая версия сборки - ";
$locale['setup_0011'] = "ru";
$locale['setup_0012'] = "utf-8";
$locale['setup_0012a'] = "ltr";
$locale['setup_0020'] = "Обновление PHPFusion";
$locale['setup_0022'] = "Добро пожаловать в службу обновления PHPFusion";
$locale['setup_0023'] = "Служба обновления проведёт Вас через все шаги, необходимые для обновления PHPFusion на Вашем сервере. Пожалуйста, следуйте этим шагам и проверяйте всю требуемую информацию.";
...
$locale['setup_0102'] = "Системные требования";
...
$locale['setup_0109'] = "Минимальная версия сервера Apache, требуемая для запуска PHPFusion без включенного mod_rewrite 2.4.";
$locale['setup_0110'] = "Из-за настроек для токена сервера в файле httpd.conf невозможно определить версию Apache без mod_rewrite, минимально необходимая версия &ndash; 2.4.";
...
$locale['setup_0113'] = "Ваша установленная копия PHP слишком старая. PHPFusion требует как минимум версии 7.0. Версии PHP выше 7.0 обеспечивают встроенную защиту от SQL-инъекций для баз данных MySQL. Рекомендуем Вам обновить свою версию.";
$locale['setup_0114'] = "PHPFusion требует наличия подключенных расширений PHP из следующего списка";
...
$locale['setup_0119b'] = "Увеличьте ваш лимит памяти путём изменения параметра memory_limit в файле [CFG_FILE_PATH]  и затем перезапустите Ваш сервер (либо свяжитесь с системым администратором или хостером для помощи).";
...
$locale['setup_0132'] = "Установите {%code%} в Вашей конфигурации PHP, так как некоторые страницы Вашего сайта PHPFusion не будут работать при слишком низком значении.";
...
$locale['setup_1001'] = "Больше переводов можно загрузить с <a href='https://phpfusion.com/translations/' target='_blank'><strong>Официального сайта поддержки PHPFusion</strong></a>";
$locale['setup_1002'] = "Добро пожаловать в режим восстановления PHPFusion 9.";
...
$locale['setup_1202a'] = "Порт БД:";
$locale['setup_1202b'] = "Оставьте пустым, если вы не используете другой порт";
...
$locale['setup_1210'] = "Возникли ошибки при установке PHPFusion. Пожалуйста, перезапустите скрипт установки.";
$locale['setup_1211'] = "Установка PHPFusion завершена. Пожалуйста, перейдите к следующему шагу.";
...
$locale['setup_1215'] = "Ваш новый сайт на PHPFusion";
$locale['setup_1216'] = "PHPFusion лёгкая система управления содержимым (CMS) с открытым исходным кодом, написанная на PHP.";
$locale['setup_1217'] = "Ваша учётная запись обновлена. Пожалуйста, с этого момента используйте новые возможности.";
$locale['setup_1220'] = "Имя базы данных, в которую вы хотите установить PHPFusion";
...
$locale['setup_1225'] = "Например: localhost";
$locale['setup_1307'] = "Проверьте доступность для записи файла config.php.";
...
$locale['setup_1509'] = "Е-майл:";
$locale['setup_1510'] = "Е-майл сайта:";
...
$locale['setup_3304'] = "Дискуссии";
$locale['setup_3305'] = "Обратная связь";
...
$locale['setup_3317'] = "Добавить блог";
$locale['setup_3318'] = "Панель архива блога";
$locale['setup_3319'] = "Последние темы";
...
$locale['setup_3327'] = "Добавить в ЧаВо";
// Stage 6 - Panels
...
$locale['setup_3608'] = "Элита";
// Stage 6 - Sample Smileys
$locale['setup_3620'] = "Улыбчивый";
$locale['setup_3621'] = "Подмигивающий";
$locale['setup_3622'] = "Печальный";
$locale['setup_3623'] = "Хмурый";
$locale['setup_3624'] = "Шокированный";
$locale['setup_3625'] = "Пфф";
$locale['setup_3626'] = "Крутой";
$locale['setup_3627'] = "Усмехающийся";
$locale['setup_3628'] = "Сердитый";
$locale['setup_3629'] = "Нравится";
...
$locale['setup_1701'] = "Ваш сайт на PHPFusion 9 готов к использованию. Нажмите Завершить для перезаписи временного файла config_temp.php в config.php<br/>";
...
$locale['setup_1703'] = "Благодарим за выбор PHPFusion.";
...
$locale['blog']['description'] = "Настройки блогов.";
...
$locale['polls']['description'] = "Настройки Опросов и Голосований Пользователей.";
