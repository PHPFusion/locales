...
$locale['SB_flood'] = "Флуд! Пожалуйсте, обождите %s сек. перед отправкой следующего сообщения.";
$locale['SB_guest_shouts'] = "Гости могут писать?";
$locale['SB_lang'] = "Язык";
$locale['SB_login_req'] = "Вы должны авторизоваться для отправки сообщений.";
$locale['SB_message'] = "Текст";
$locale['SB_name'] = "Название";
$locale['SB_reply'] = "Ответить";
$locale['SB_reply_to'] = "Ответить на:";
...
$locale['SB_visbility'] = "Показывать для:";
...
$locale['SB_blocked_user'] = "Сообщение скрыто, потому что вы заблокировали этого пользователя.";
