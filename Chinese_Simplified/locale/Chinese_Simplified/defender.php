...
$locale['error_request'] = "There was an error while processing your request";
$locale['regex_error'] = "Please check and revalidate the %s field";
// Text fields errors
...
$locale['error_invalid_theme'] = "Please select a valid theme";
