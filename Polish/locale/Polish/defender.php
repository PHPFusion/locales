<?php
$locale['validate'] = "Sprawdź i potwierdź to pole.";
$locale['error_request'] = "Podczas przetwarzania żądania wystąpił błąd"; // to be moved
$locale['regex_error'] = "Proszę sprawdzić i ponownie zweryfikować pole %s"; // to be moved
// Text fields errors
$locale['error_input_username'] = "Proszę podać poprawną nazwę użytkownika";
...
$locale['error_input_url'] = "Proszę podać poprawny adres witryny";
...
$locale['df_304'] = "Selected file RePrzenieś";
...
$locale['grecaptcha_placeholder_1'] = "SITE KEY z Google";
