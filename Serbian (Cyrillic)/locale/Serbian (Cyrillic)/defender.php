<?php
$locale['validate'] = "Молимо вас да поново проверите поље.";
$locale['error_request'] = "Дошло је до грешке у обради вашег захтева";
$locale['regex_error'] = "Молимо вас да поново проверите %s поље";
// Text fields errors
$locale['error_input_username'] = "Молимо вас да унесете исправно корисничко име";
$locale['error_input_default'] = "Молимо вас да попуните ово поље";
$locale['error_input_password'] = "Молимо вас да унесете исправну лозинку";
$locale['error_input_email'] = "Унесите важећу адресу е-поште";
$locale['error_input_number'] = "Молимо вас да унесете важећи број";
$locale['error_input_url'] = "Унесите важећу УРЛ адресу";
$locale['error_input_regex'] = "Молимо вас унесите важећи образац";
$locale['error_input_safemode'] = "Молимо вас да правилно попуните ово поље";
$locale['error_input_check'] = "Молимо вас да унесете тачну вредност поља";
$locale['df_error_text'] = "%s has error and requires your attention.";
$locale['error_invalid_theme'] = "Молимо вас да изаберете важећу тему";
$locale['error_input_checkbox'] = "Молимо вас да штиклирате ово поље";
$locale['error_input_file'] = "Молимо вас да изаберете важећу датотеку";
$locale['error_secure_file'] = "Учитана датотека је одбијена због могућег злонамерног садржаја.";
$locale['error_input_login'] = "Неважеће корисничко име или лозинка";
// Admin Login
$locale['cookie_title'] = "Време је истекло";
