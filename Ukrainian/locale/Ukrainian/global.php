<?php
$locale['setlocale'] = "uk_UA"; // https://www.php.net/manual/en/function.setlocale.php
...
$locale['username_pretext'] = "Ваше загальнодоступне ім&lsquo;я користувача співпадає з адресою облікового запису в: %s %s";
...
$locale['global_104'] = "Авторизація";
$locale['global_105'] = "Ще не зареєстровані?

[LINK]Зареєструватися[/LINK]";
$locale['global_106'] = "Не пам&lsquo;ятаєте пароль?
...
$locale['UM065'] = "Ще не зареєстровані?
...
$locale['global_197'] = "Будь ласка, зачекайте ...

Відбувається перевірка авторизації Вашого облікового запису.
...
Майте на увазі, що завантажена тема повинна мати ту ж назву (враховуючи регістр символів; важливо для Unix-серверів), що й вибрана тема в налаштуванні Центру керування.


Якщо Ви звичайний користувач, будь ласка, зв&lsquo;яжіться з адміністратором сайту за електронною адресою [SITE_EMAIL] та повідомте про цю проблему.";
$locale['global_302'] = "Вибрану тему оформлення не вдається знайти або її пошкоджено!";
// JavaScript Not Enabled
$locale['global_303'] = "Ой, сталась помилка! А де ж JavaScript?

Схоже, що Ваш переглядач не підтримує технологію JavaScript або її вимкнено. Будь ласка, увімкніть JavaScript для коректного відображення цього сайту,

або використайте іншого переглядача інтернет сторінок, який має підтримку JavaScript.";
// User Management
...
$locale['global_ML103'] = "Зміна мови";
// Flood Control
...
$locale['register'] = "Реєстрація на сайті";
$locale['ban'] = "Бан";
...
$locale['fmt_vote'] = "голос|голоси|голосів";
...
$locale['fmt_admin'] = "адміністратор|адміністратори|адміністраторів";
$locale['fmt_group'] = "група|групи|груп";
