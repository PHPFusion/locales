...
$locale['error_request'] = "Під час обробки запиту сталась помилка"; // to be moved
$locale['regex_error'] = "Будь ласка, перевірте і повторно підтвердіть значення поля %s"; // to be moved
// Text fields errors
$locale['error_input_username'] = "Будь ласка, введіть коректне ім&lsquo;я";
...
$locale['error_input_checkbox'] = "Будь ласка, позначте цей пункт"; // to be moved
...
// Address errors
$locale['street_error'] = "Зверніть увагу на адресу.";
$locale['country_error'] = "Зверніть увагу на країну.";
$locale['state_error'] = "Зверніть увагу на регіон.";
$locale['city_error'] = "Зверніть увагу на місто.";
$locale['postcode_error'] = "Зверніть увагу на поштовий індекс.";
...
$locale['name_error'] = "Ім&lsquo;я та прізвище не можуть співпадати.";
// Document errors
...
$locale['token_error_4'] = "Некоректний код UserID у ключі.";
...
$locale['df_300'] = "Натисніть, щоб додати файли";
...
$locale['df_405'] = "Посилання %s некоректне.";
