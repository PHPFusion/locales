<?php
$locale['setup_0000'] = "Instalação do PHPFusion";
$locale['setup_0002'] = "Bemvindo à Instalação do PHPFusion";
$locale['setup_0003'] = "O guia de instalação irá guiá-lo pelos passos necessários para instalar o PHPFusion CMS no seu servidor. Caso precise de mais ajuda, por favor, verifique a nossa <a class='strong' href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=216' target='_blank'>Documentação de Instalação Online</a>.";
$locale['setup_0005'] = " Eu li e aceito os <a href='https://phpfusion.com/licensing/?agpl' target='_blank'>Termos e Condições de Uso</a> do PHPFusion";
$locale['setup_0006'] = "PHPFusion 9 requer pelo menos PHP 7.0. Veja os <a href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=215'>requesitos de sistema</a> para mais informações.";
...
$locale['setup_5000'] = "Para utilizar o PHPFusion é necessário verificar e concordar com os termos do PHPFusion.";
$locale['setup_0010'] = "Versão actual da compilação - ";
$locale['setup_0011'] = "en";
$locale['setup_0012'] = "utf-8";
$locale['setup_0012a'] = "ltr";
$locale['setup_0020'] = "Actualização do PHPFusion";
$locale['setup_0022'] = "Bemvindo ao serviço de actualização do PHPFusion";
$locale['setup_0023'] = "O serviço de actualização irá guiá-lo pelos passos necessários para actualizar o PHPFusion CMS no seu servidor. Por favor, siga estes passos e verifique cada informação necessária.";
...
$locale['setup_0109'] = "A versão mínima do Apache necessária para executar o PHPFusion sem mod_rewrite activado é 2.2.16.";
...
$locale['setup_0113'] = "A sua instalação do PHP é muito antiga. O PHPFusion requer pelo menos no mínimo o PHP 7.0. Versões do PHP maiores que 5.6.39 fornecem proteção de injeção SQL embutida para bases de dados mysql. Recomenda-se actualizar.";
$locale['setup_0114'] = "PHPFusion requer que você active as extensões PHP da seguinte lista";
...
$locale['setup_0119b'] = "Aumente o limite de memória editando o parâmetro memory_limit no ficheiro [CFG_FILE_PATH] e reinicie o seu servidor web (ou entre em contacto com o administrador do sistema ou com a empresa de alojamento para obter ajuda).";
...
$locale['setup_0132'] = "Defina {%code%} em sua configuração PHP visto algumas páginas no seu site PHPFusion não funcionarão enquanto essa configuração estiver muito baixa.";
...
$locale['setup_1001'] = "Descarregue mais idiomas no <a href='https://phpfusion.com/php_fusion_9_downloads.php' target='_blank'><strong>Site de Suporte Oficial do PHPFusion</strong></a>";
$locale['setup_1002'] = "Bemvindo ao Modo de Recuperação do PHPFusion 9.";
...
$locale['setup_1210'] = "Erros na Instalação do PHPFusion. Por favor reinicie o instalador.";
$locale['setup_1211'] = "A nova instalação do PHPFusion terminou. Por favor prossiga para o próximo passo.";
...
$locale['setup_1216'] = "O PHPFusion é um Sistema de Administração de Conteúdos (CMS) open source escrito em PHP.";
$locale['setup_1217'] = "A sua conta foi actualizada. Por favor use os novos detalhes a partir de agora.";
$locale['setup_1220'] = "O nome da base de dados onde quer correr o PHPFusion";
...
$locale['setup_3309'] = "Pesquisar";
$locale['setup_3310'] = "Enviar Link";
...
$locale['setup_3321'] = "Seguir tópico";
$locale['setup_3322'] = "Tópicos por responder";
$locale['setup_3323'] = "Perguntas sem resposta";
$locale['setup_3324'] = "Iniciar Novo Tópico";
$locale['setup_3325'] = "Artigos mais Recentes";
...
$locale['setup_1701'] = "PHPFusion 9 já está pronto para ser usado. Clique em Concluir para reescrever o seu ficheiro config_temp.php para config.php<br/>";
...
$locale['setup_1703'] = "Obrigado por escolher o PHPFusion.";
