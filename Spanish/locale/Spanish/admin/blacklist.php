...
$locale['BLS_013'] = "Usuario eliminado de la lista negra";
$locale['BLS_014'] = "¿Está seguro de que desea eliminar esta entrada?";
$locale['BLS_015'] = "La lista negra está actualmente vacía.";
$locale['BLS_016'] = "La dirección de correo electrónico de la lista negra no es un correo electrónico válido.";

$locale['BLS_020'] = "Usuario de la lista negra";
$locale['BLS_021'] = "Editar usuario en la lista negra";
$locale['BLS_022'] = "Agregar usuario en la lista negra";
$locale['BLS_023'] = "Actualmente muestra %d de %d entradas de lista negra.";

$locale['BLS_030'] = "Información en la lista negra";
$locale['BLS_031'] = "Administrador";
$locale['BLS_032'] = "Fecha";
$locale['BLS_033'] = "Opciones";
$locale['BLS_034'] = "Dirección IP de la lista negra: <strong> o </ strong>";
...
domain.tld es un alias de %@domain.tld para hacerlo compatible con las reglas definidas en v7.<br />";
