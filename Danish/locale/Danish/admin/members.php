...
Følgende indhold <u>oprettet af denne bruger</u> på denne hjemmeside vil blive slettet hvis du fortsætter:<br />
- Artikler<br />
- Nyheder<br />
- Debatforumtråde. Bemærk at indlæg oprettet af andre brugere i disse tråde også vil blive slettet, sammen med afgivne stemmer i afstemninger og filvedhæftelser.<br/>
- Debatforumindlæg<br/>
- Debatforum vedhæftelser<br/>
- Kommentarer<br/>
- Private beskeder sendt eller modtaget af denne bruger<br/>
- Afgivne afstemningsstemmer<br/>
- Afgivne bedømmelser<br/>
...
$locale['604'] = "Årsag:";
// Deactivation System
$locale['610'] = "<strong>%d bruger(e)</strong> har ikke været logget på i <strong>%d dag(e)</strong> og er markeret som inaktive.  Ved at deaktivere disse brugere vil de få <strong>%d dag(e)</strong> før de bliver %s.";
$locale['611'] = "Bemærk at visse brugere kan have bidraget med indhold til siden så som debatindlæg, kommentarer, billeder og så videre. Dette indhold vil blive slettet, hvis deaktiverede brugere slettes.";
$locale['612'] = "bruger";
$locale['613'] = "brugere";
