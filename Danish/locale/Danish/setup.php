...
$locale['setup_0002'] = "Velkommen til installationsprogrammet for PHPFusion";
$locale['setup_0003'] = "Guiden her vil føre dig gennem de nødvendige trin til installationen af CMS-løsningen PHPFusion på din server. Har du brug for yderligere hjælp, så kig i vores online <a class='strong' href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=216' target='_blank'>installationshjælp</a>.";
$locale['setup_0005'] = " Jeg har læst og accepteret de relevante PHPFusion <a href='https://phpfusion.com/licensing/?agpl' target='_blank'>betingelser</a>";
$locale['setup_0006'] = "PHPFusion 9 skal bruge PHP i mindst version 5.6.39. Se <a href='https://phpfusion.com/infusions/wiki/documentation.php?page_id=215'>systemkravene</a> for at få mere information.";
...
$locale['setup_5000'] = "For at kunne bruge PHPFusion, skal du acceptere betingelserne.";
$locale['setup_0010'] = "Nuværende Build Version - ";
$locale['setup_0011'] = "da";
$locale['setup_0012'] = "utf-8";
$locale['setup_0012a'] = "ltr";
$locale['setup_0020'] = "PHPFusion Opgradering";
$locale['setup_0022'] = "Velkommen til PHPFusions opgraderingsfunktion";
$locale['setup_0023'] = "Denne opgraderingsfunktion vil guide dig gennem de nødvendige trin for at du kan opgradere PHPFusion på din server. Følg de enkelte trin nøje og kontroller alle nødvendige informationer.";
$locale['setup_0050'] = "Webserver";
$locale['setup_0051'] = "PHP-version";
$locale['setup_0052'] = "PHP-udvidelser";
...
$locale['setup_0105'] = "Opsætning af kernesystemet";
$locale['setup_0106'] = "De vigtigste administrator informationer";
$locale['setup_0107'] = "Afsluttende opsætning";
$locale['setup_0109'] = "Ældste version af Apache nødvendig for at kunne afvikle PHPFusion uden at mod_rewrite er slået til, er 2.2.16.";
...
$locale['setup_0113'] = "Den version af PHP, som er installeret på din server er for gammel. PHPFusion skal bruge mindst version af 5.6.39. PHP-versioner over 5.6.39 er udstyret med indbyggede blokeringer mod SQL injection for at beskytte databaserne. Det anbefales at man opgraderer.";
$locale['setup_0114'] = "PHPFusion kræver at du slår PHP extension til i følgende liste";
...
$locale['setup_0132'] = "Sæt {%code%} i din PHP-konfiguration da nogle sider på din PHPFusion side ikke vil virke da denne værdi er sat for lavt.";
...
$locale['setup_0143'] = "Det angivne tabel-fornavn er allerede i brug og åbent. Installationsprogrammet vil gå videre og foretage de nødvendige ændringer";
$locale['setup_0144'] = "Diagnosen af databasen er gennemført";
// Step 1
$locale['setup_1000'] = "Du skal vælge sprog";
$locale['setup_1001'] = "Hent flere lokale sprogversioner fra <a href='https://phpfusion.com/php_fusion_9_downloads.php' target='_blank'><strong>PHPFusions officielle støtteside</strong></a>";
$locale['setup_1002'] = "Velkommen til PHPFusion 9 Genskabelse.";
...
$locale['setup_1008'] = "Installation af kernefunktioner";
...
$locale['setup_1019'] = "Afslut installationen";
...
$locale['setup_1208'] = "Databasedriver";
// Step 4 - Database Setup
$locale['setup_1210'] = "PHPFusion installationsfejl. Venligst genstart installeringen.";
$locale['setup_1211'] = "Ny PHPFusion installation færdiggjort. Fortsæt venligst til næstre trin.";
...
$locale['setup_1215'] = "En side oprettet med PHPFusion";
$locale['setup_1216'] = "PHPFusion er et letvægts open source content management system (CMS) kodet i PHP.";
$locale['setup_1217'] = "Din brugerkonto er opdateret. Brug venligst de nye informationer fremover.";
$locale['setup_1220'] = "Navnet på den database, du vil anvende som basis for PHPFusion";
...
$locale['setup_1307'] = "Kontroller at din config.php har de korrekte skriverettigheder.";
...
$locale['setup_1315'] = "Du skal sikre dig, at den angivne MySQL-bruger til databasen har læse, skrive og slette tilladelse i den angivne database.";
...
$locale['setup_5013'] = "Kodeordet overholder ikke reglerne. Der må kun bruges alfanumeriske karakterer.<br/>Og kodeordet skal være på mindst 8 tegn.";
$locale['setup_5015'] = "De to administratorkodeord er ikke identiske.";
$locale['setup_5016'] = "Log ind kodeord og administratorkodeord må ikke være ens.";
...
$locale['setup_3036'] = "Privat besked";
$locale['setup_3037'] = "Brugerfelter";
$locale['setup_3038'] = "Debatforumrang";
...
$locale['setup_3051'] = "Sprogindstillinger";
$locale['setup_3052'] = "Permalinks";
$locale['setup_3055'] = "Blog";
$locale['setup_3056'] = "Temamanager";
$locale['setup_3057'] = "Migreringsværktøjer";
$locale['setup_3058'] = "Temaindstillinger";
$locale['setup_3059'] = "Fusion filmanager";
...
$locale['setup_3212'] = "Debatforumrang";
...
$locale['setup_3317'] = "Foreslå blogindlæg";
$locale['setup_3318'] = "Blogarkiv";
$locale['setup_3319'] = "Nyeste emner";
$locale['setup_3320'] = "Medvirket i debatter";
$locale['setup_3321'] = "Fulgte tråde";
$locale['setup_3322'] = "Ubesvarede tråde";
$locale['setup_3323'] = "Uløste spørgsmål";
$locale['setup_3324'] = "Start ny tråd";
...
$locale['setup_3402'] = "Debatforumtråde";
$locale['setup_3404'] = "Velkomstbesked";
$locale['setup_3405'] = "Liste over debattråde";
...
$locale['setup_1701'] = "PHPFusion version 9 er nu klar til at blive taget i brug. Klik på afslut for at få gemt din config_temp.php fil som config.php<br/>";
...
$locale['setup_1703'] = "Tak fordi du valgte PHPFusion.";
...
$locale['setup_3800'] = "Skabeloner til mails";
...
$locale['faqs']['description'] = "Ofte stillede spørgsmål-system.";
