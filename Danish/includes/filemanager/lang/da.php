...
+--------------------------------------------------------+
| Filename: locale/Danish/includes/filemanager/da.php
...
return array(
    ...
    'Error_extension' => 'Filtypen er ikke tilladt.',
    'Upload_file' => 'Upload',
    'Filters' => 'Filter',
    'Videos' => 'Videoer',
    'Music' => 'Musik',
    ...
    'Upload_base_help' => "Drag & Drop filer (moderne browsere) eller klik på upper-knappen for at tilføje fil(er) og klik på Start upload. Når upload er færdig, klik på 'Tilbage til filliste'-knappen.",
    'Upload_add_files' => 'Tilføj fil(er)',
    'Upload_start' => 'Start upload',
    'Upload_error_messages' =>array(
        1 => 'Den uploadede fil overstiger upload_max_filesize indstillingen i php.ini',
        2 => 'Den uploadede fil overstiger MAX_FILE_SIZE indstillingen indtastet i HTML-formularen',
        3 => 'Den uploade fil er kun delvist uploadet',
        4 => 'Ingen fil uploadet',
        6 => 'Mangler en midlertidig folder',
        7 => 'Kunne ikke skrive til disk',
        8 => 'En PHP extension stoppede filupload',
        'post_max_size' => 'Den uploade defil overstiger post_max_size indstillingen i php.ini',
        'max_file_size' => 'Filen er for stor',
        'min_file_size' => 'Filen er for lille',
        'accept_file_types' => 'Filetype ikke tilladt',
        'max_number_of_files' => 'Maksimum antal af filer overskredet',
        ...
        'image_resize' => 'Kunne ikke resize billede'
    ),
    'Upload_url' => 'Fra url',
    'Type_dir' => 'dir',
    'Type' => 'Type',
    ...
    'max_size_reached' => "Din billedfolder har nået sin maksimale størrelse på %d MB.", //%d = max overall size
    'B' => "B",
    'KB' => "KB",
    'MB' => "MB",
    'GB' => "GB",
