...
$locale['homeSetup_0113'] = "Vores tema leverer formidabelt design og kraftfulde features til din hjemmeside. Pixel perfektioneret for at vise din hjemmesides alsidighed.";
$locale['homeSetup_0114'] = "Derfor vil du elske PHP-Fusion 9";
$locale['homeSetup_0115'] = "Med over en million genskrevne kodelinjer, der vil modernisere CMS på en hidtil uset måde, bevarer PHP-Fusion 9 sin letvægtshurtighed og er smartere og smukkere end nogensinde.";
$locale['homeSetup_0116'] = "Worldwide Developers Forum";
$locale['homeSetup_0117'] = "[h4]PHP-Fusion Developers Network[/h4]";
$locale['homeSetup_0118'] = "[p]Få assistance i kodeudvikling, find udviklere eller funding ideer og road-maps der lægges frit frem, alt kan ske.
Vær med i et verdensomspændende open source samarbejde i dag.[/p]";
$locale['homeSetup_0119'] = "Utroligt nemt for alle";
