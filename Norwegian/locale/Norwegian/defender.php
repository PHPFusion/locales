...
$locale['state_error'] = "Distriktsbeskrivelsen må kontrolleres.";
$locale['city_error'] = "Bynavnet må kontrolleres.";
$locale['postcode_error'] = "Postnummeret må kontrolleres.";
$locale['field_error_blank'] = "%s kan ikke stå tomt.";
// Name errors
$locale['firstname_error'] = "Fornavn må kontrolleres.";
$locale['lastname_error'] = "Etternavn må kontrolleres.";
$locale['name_error'] = "Fornavn og etternavn kan ikke være identiske.";
// Document errors
$locale['doc_type_error'] = "Dokumenttypen må kontrolleres.";
$locale['doc_series_error'] = "Dokumentserien må kontrolleres.";
$locale['doc_number_error'] = "Dokumentnummeret må kontrolleres.";
$locale['doc_authority_error'] = "Dokument autoritet må kontrolleres.";
$locale['date_issue_error'] = "Dokumentdato må kontrolleres.";
// Tokens
$locale['token_error_title'] = "Kode Feil";
$locale['token_error'] = "Vi beklager, det oppstod en feil. Gå tilbake, oppdater siden og prøv så på nytt.";
$locale['token_error_1'] = "Oppgaven ble ikke startet.";
$locale['token_error_2'] = "Koden ble ikke lagret.";
$locale['token_error_3'] = "Ugyldig kode.";
